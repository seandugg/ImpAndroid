 ...
 * 		-> Fever Duration: 9 Days
 * 		-> Patient Age is younger than 5 months
 * 
 ...
 *
 */
public class CcmFeverInfantDangerSignDiagnosticTest extends CcmDiagnosticRuleEngineTest {
	
	private static final String FEVER_DURATION_IN_DAYS = "9";
	private static final int PATIENT_AGE_IN_MONTHS = 4;
	
    public CcmFeverInfantDangerSignDiagnosticTest() {
        super(); 
    }
    ...
    public void setUp() {
    	...
    	// 3. Patient Age is younger than 5 months
    ...
    public void testFeverDangerSign() {
       ...
       assertEquals("the actual number of patient classifications does not match the expected number",
        ...
        assertEquals("incorrect treatment assessed", true, CcmRuleEngineUtilities.treatmentPresent(getPatientAssessment().getDiagnostics(), "Dose for LA: Not recommended"));
