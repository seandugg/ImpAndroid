 ...
 *
 */
public class CcmFastBreathingAndChestIndrawingOlderChildDiagnosticTest extends CcmDiagnosticRuleEngineTest {
	
	private static final String BREATHS_PER_MINUTE = "46";
	private static final int PATIENT_AGE_IN_YEARS = 4;
	
    public CcmFastBreathingAndChestIndrawingOlderChildDiagnosticTest() {
        super(); 
    }
    ...
    public void setUp() {
    	...
    	// 1. Patient Age is older than 12 months and younger than 5 years
