 ...
 *
 */
public class CcmFeetSwellingDangerSignDiagnosticTest extends CcmDiagnosticRuleEngineTest {
	
    public CcmFeetSwellingDangerSignDiagnosticTest() {
        super(); 
    }
    ...
    public void setUp() {
    	...
    	// 1. Swelling of Both Feet: YES
    	String reviewItemLabel = getResources().getString(R.string.ccm_look_assessment_review_swelling_of_both_feet);
    	String reviewItemSymptomId = getResources().getString(R.string.ccm_look_assessment_swelling_of_both_feet_symptom_id);
    	String reviewItemIdentifier = getResources().getString(R.string.ccm_look_assessment_swelling_of_both_feet_id);
     ...
     * the danger sign: 'Swelling of Both Feet'
     * 
     */
    public void testFeetSwellingDangerSign() {
       ...
       assertEquals("the actual number of patient classifications does not match the expected number",
        ...
        assertEquals("incorrect classification assessed", true, CcmRuleEngineUtilities.classificationPresent(getPatientAssessment().getDiagnostics(), "Swelling of Both Feet"));
