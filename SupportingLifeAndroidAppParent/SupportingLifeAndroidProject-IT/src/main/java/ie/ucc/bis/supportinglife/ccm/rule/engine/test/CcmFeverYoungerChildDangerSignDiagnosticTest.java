 ...
 * 		-> Patient Age is older than 5 months and younger than 3 years
 * 
 ...
 * 		-> Give first dose of LA: 1 tablet
 ...
 *
 */
public class CcmFeverYoungerChildDangerSignDiagnosticTest extends CcmDiagnosticRuleEngineTest {
	
	private static final String FEVER_DURATION_IN_DAYS = "8";
	private static final int PATIENT_AGE_IN_YEARS = 2;
	
    public CcmFeverYoungerChildDangerSignDiagnosticTest() {
        super(); 
    }
    ...
    public void setUp() {
    	...
    	// 3. Patient Age is older than 5 months and younger than 3 years
    ...
    public void testFeverDangerSign() {
       ...
       assertEquals("the actual number of patient classifications does not match the expected number",
        ...
        assertEquals("incorrect treatment assessed", true, CcmRuleEngineUtilities.treatmentPresent(getPatientAssessment().getDiagnostics(), "Give first dose of LA: 1 tablet"));
