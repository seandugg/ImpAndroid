 ...
 *
 */
public class CcmChestIndrawingYoungerChildDangerSignDiagnosticTest extends CcmDiagnosticRuleEngineTest {
	
	private static final int PATIENT_AGE_IN_MONTHS = 6;
	
    public CcmChestIndrawingYoungerChildDangerSignDiagnosticTest() {
        super(); 
    }
    ...
    public void setUp() {
    	...
    	// 2. Patient Age is older than 2 months and younger than 12 months
